...
void ControlPoints::writeToFile(std::vector<MouseCallbackParams*> control_points){
    std::ofstream input;
...
void ControlPoints::printControlPixels(std::vector<MouseCallbackParams*>& control_points){
    std::cout << std::endl;
...
void ControlPoints::printControlXYZ(std::vector<cv::Point3f>& XYZ_control_points){
